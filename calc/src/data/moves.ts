...
delete BW['Smog'];
delete BW['Whirlpool'];
delete BW['Poison Sting'];
delete BW['Vital Throw'];
delete BW['Razor Shell'];
delete BW['Head Charge'];
delete BW['Low Sweep'];
delete BW['Sand Tomb'];
...
const XY_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Drill Run': {bp: 90},
  'Horn Leech': {bp: 85},
  'Leaf Tornado': {bp: 60, target: 'allAdjacentFoes'},
  Steamroller: {bp: 85},
  'Night Daze': {bp: 120, category: 'Physical', recoil: [33, 100]},
  'Gear Grind': {category: 'Special'},
  'Relic Song': {bp: 120, category: 'Physical', secondaries: false},
  Glaciate: {bp: 100},
  Snarl: {bp: 60},
  'Icicle Crash': {bp: 90},
  'V-create': {bp: 150, recoil: [1, 2]},
  'Spacial Rend': {bp: 120, category: 'Physical'},
  'Ominous Wind': {bp: 100, target: 'allAdjacentFoes'},
  Venoshock: {bp: 70, category: 'Physical'},
  'Flame Charge': {bp: 60},
  'Thunder Fang': {bp: 75},
  'Fire Fang': {bp: 75},
  'Ice Fang': {bp: 75},
  ...
  'Rock Wrecker': {bp: 140, recoil: [33, 100]},
  'Charge Beam': {bp: 60},
  'Double Hit': {bp: 60},
  'Roar of Time': {bp: 140, recoil: [33, 100]},
  'Seed Bomb': {secondaries: true},
  'Power Gem': {secondaries: true},
  'Drain Punch': {bp: 80},
  'Poison Fang': {bp: 75},
  'Crush Claw': {bp: 100},
  'Icy Wind': {bp: 60},
  'Giga Drain': {bp: 80},
  'Blast Burn': {bp: 140, recoil: [33, 100], target: 'allAdjacentFoes'},
  'Hydro Cannon': {bp: 140, recoil: [33, 100], target: 'allAdjacentFoes'},
  'Frenzy Plant': {bp: 140, recoil: [33, 100], target: 'allAdjacentFoes'},
  'Silver Wind': {bp: 80},
  'Shadow Punch': {bp: 80},
  'Icicle Spear': {bp: 35, multihit: [2, 2]},
  'Mud Shot': {bp: 60},
  'Poison Tail': {bp: 80},
  'Hammer Arm': {secondaries: true},
  'Sucker Punch': {isPunch: true},
  'Poison Jab': {bp: 90, isPunch: true},
  'False Swipe': {bp: 60},
  Spark: {bp: 85},
  'Dragon Breath': {bp: 60, target: 'allAdjacentFoes'},
  'Metal Claw': {bp: 60},
  'Karate Chop': {bp: 70},
  'Mega Punch': {secondaries: true},
  'Fire Punch': {bp: 80},
  'Ice Punch': {bp: 80},
  'Thunder Punch': {bp: 80},
  ...
  'Wing Attack': {bp: 80},
  Fly: {bp: 100},
  Slam: {secondaries: true},
  'Double Kick': {bp: 35, multihit: [2, 2]},
  'Take Down': {recoil: [0, 1]}, 
  Twineedle: {bp: 40},
  'Hyper Beam': {recoil: [1, 2]},
  Peck: {bp: 40},
  Strength: {type: 'Rock', secondaries: true},
  'Mega Drain': {bp: 60},
  'Razor Leaf': {bp: 60},
  'Fire Spin': {bp: 30},
  'Rock Throw: {bp: 60},
  Dig: {bp: 100},
  Lick: {bp: 60},
  'Spike Cannon': {type: 'Ground'},
  Constrict: {bp: 60},
  'Leech Life': {bp: 80},
  'Fury Swipes': {type: 'Dark'},
  'Super Fang': {type: 'Dark'},
  'Flame Wheel': {bp: 70},
  Twister: {bp: 60, target: allAdjacentFoes},
  'Rock Smash': {bp: 70},
  'Fake Out': {bp: 30, type: 'Dark', priority: 1},
  Superpower: {recoil: [33, 100]},
  Dive: {bp: 100},
  ...
  Absorb: {bp: 40},
  Acrobatics: {bp: 60},
  Aeroblast: {bp: 120, makesContact: true, category: 'Physical'},
  'Air Slash': {bp: 80},
  'Ancient Power': {bp: 80},
  'Arm Thrust': {bp: 25},
  Astonish: {bp: 50, category: 'Special'},
  'Attack Order': {bp: 100, makesContact: true},
  Barrage: {type: 'Steel', isBullet: true},
  'Brick Break': {bp: 80},
  'Bug Buzz': {bp: 95},
  Bubble: {bp: 40},
  Chatter: {bp: 90},
  'Earth Power': {bp: 95},
  'Energy Ball': {bp: 95},
  'Egg Bomb': {type: 'Grass', category: 'Special', isBullet: true},
  ...
  'Mist Ball': {bp: 60, target: 'allAdjacentFoes', isBullet: true},
  ...
  'Bullet Seed': {bp: 35, isBullet: true, multihit: [2, 2]},
  Charm: {type: 'Fairy'},
  'Cotton Spore': {target: 'allAdjacentFoes'},
  Crabhammer: {bp: 100, isPunch: true},
  'Dark Pulse': {bp: 90, isPulse: true},
  'Draco Meteor': {bp: 130},
  ...
  Lick: {bp: 30},
  'Muddy Water': {bp: 90},
  Octazooka: {isBullet: true, bp: 85, secondaries: false},
  Overheat: {bp: 130},
  'Pin Missile': {bp: 25},
  'Power Gem': {bp: 80},
  ...
  'Vine Whip': {bp: 40, priority: 1},
  'Water Pledge': {bp: 120},
  'Water Pulse': {bp: 80, isPulse: true},
  'Weather Ball': {isBullet: true},
  'Zap Cannon': {bp: 140, isBullet: true, recoil: [33, 100]},
  'Wicked Blow' {
    bp: 75,
    type: 'Dark',
    category: 'Physical',
  ...
  'Land\'s Wrath': {bp: 100, type: 'Ground', target: 'allAdjacentFoes', category: 'Special'},
  'Light of Ruin': {bp: 140, type: 'Fairy', recoil: [1, 3], category: 'Special'},
  'Oblivion Wing': {
    bp: 90,
    type: 'Flying',
    drain: [3, 4],
